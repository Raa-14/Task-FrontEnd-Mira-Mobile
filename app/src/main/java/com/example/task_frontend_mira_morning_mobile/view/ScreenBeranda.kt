...
import com.example.task_frontend_mira_morning_mobile.body.NavbarTopBeranda
...
fun BerandaBody(navController: NavController) {
    ...
    Column(
        ...
        NavbarTopBeranda(navController)
        BerandaBodyScreen(navController)
...
private fun BerandaBodyPreview() {
    BerandaBody(navController = rememberNavController())
}
