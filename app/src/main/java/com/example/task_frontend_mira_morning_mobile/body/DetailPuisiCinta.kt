...
@Composable
fun DetailPuisiCinta(navController: NavController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Card(
            ...
            Column(
                ...
                // Gambar buku
                Image(
                    painter = painterResource(id = R.drawable.puisicinta),
                ...
                Text(
                    text = buildAnnotatedString {
                        ...
                        append("Bentang Pustaka\n")

                        withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) { append("Sinopsis: ") }
                        append(
                            "Buku ini adalah kumpulan puisi cinta yang terbagi dalam tiga masa dalam hidup " +
                                    "W.S. Rendra: Puber Pertama (1954-1958), Puber Kedua (1968-1977), dan Puber Ketiga (1998-2021). " +
                                    "Puisi-puisi dalam buku ini mencerminkan perjalanan cinta Rendra dari masa mudanya yang sederhana dan manis, " +
                                    "hingga kedewasaannya yang lebih kompleks dan mendalam..\n"
                        )
                    },
...
@Preview
@Composable
private fun DetailPuisiCintaPreview() {
    DetailPuisiCinta(navController = rememberNavController())
}